...
\label{sec:quick_start}
  ...
  \subsection{Step 3: Normalize to total reflection and add the first dataset}
    \begin{wrapfigure}[12]{r}{0.4\textwidth}
     \includegraphics[width=165pt]{screenshots/totalreflection-screenshot.png} 
    \end{wrapfigure}
    ...
    \includegraphics[width=115pt]{screenshots/cutpoints-screenshot.png} (can be done automatically with the \textbf{Cut Points (L/R)} \icon{cutPoints} action if not already performed after direct beam selection). Than activate the \textbf{Set Scaling action} \icon{totalReflection} to normalize the total reflection to one.
